...
package com.example.ajeet.usertorobot;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSendFB = (Button) findViewById(R.id.btnAISendFB);
        mbtnBal = (Button) findViewById(R.id.btnAIBalance);
        ...
        btnSendFB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                demoRef.child("ruser").setValue("user");

            }
        });

        mbtnBal.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void getAIData() {
        ...
        demoRef.child("user_data").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                value = dataSnapshot.child("data").getValue(String.class);
                ImageView mImgView = (ImageView) findViewById(R.id.imagview1);
