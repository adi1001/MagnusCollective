 ...
 * when BroadcastReceiver is receiving data for text to speech conversion.
 */
public class TextToSpeechReceiver extends BroadcastReceiver {
    public TextToSpeechReceiver() {
    }
