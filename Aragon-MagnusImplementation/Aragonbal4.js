...
web3.eth.call({
    ...
    data: contractData4 // Combination of contractData and tknAddress, required to call the balance of an address
    }, function(err, result) {
        ...
        if (result != '0x') {
                ...
                console.log('Ack Tokens(VOTE) Owned by Rough Snowflake: ' + tokens);
        }
        else {
                console.log('Ack Tokens(VOTE) Owned by Rough Snowflake: error in retriving Token details please refresh the page.'); // Dump errors here
        }
