...
//This class was developed by Ingen Dynamics Inc. for use in Magnus Collective. This class is called
...
web3.eth.call({
    ...
    data: contractData1 // Combination of contractData and tknAddress, required to call the balance of an address
    }, function(err, result) {
        ...
        if (result != '0x') {
                ...
                console.log('Ack Tokens(VOTE) Owned by Solitary Resonance: ' + tokens);
        }
        else {
                console.log('Ack Tokens(VOTE) Owned by Solitary Resonance: error in retriving Token details please refresh the page.'); // Dump errors here
        }
