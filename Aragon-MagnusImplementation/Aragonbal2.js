...
web3.eth.call({
    ...
    data: contractData2 // Combination of contractData and tknAddress, required to call the balance of an address
        ...
        if (result != '0x') {
                ...
                console.log('Ack Tokens(VOTE) Owned by Throbbing Shape: ' + tokens);
        }
        else {
                console.log('Ack Tokens(VOTE) Owned by Throbbing Shape: error in retriving Token details please refresh the page.'); // Dump errors here
        }
